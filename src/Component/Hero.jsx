  ...
  return (
    <>
      <div className="max-h-screen overflow-y-auto lg:max-h-full lg:overflow-hidden">
        <img
          className="absolute ml-[1400px] mt-[150px]"
        ...
        <img
          ...
          alt=""
          className="absolute ml-[684px] top-[153px] w-[14.99px] h-[17.81px]"
        />
        <img
          src="/Images/Star 4.png"
          alt=""
          className=" absolute ml-[290px] top-[206px] h-[22.16px] w-[20px] "
        />
        <img
          src="/Images/Star 8.png"
          alt=""
          className="absolute ml-[918px] top-[715px]"
        />
        <div className=" flex justify-around w-[1200px] h-[573px] ml-[50px] gap-[29px] items-center mt-20  bg-gradient-radial from-blue-900 to-teal-800">
          <div className="">
            <h1 className=" text-4xl ml-[225px]   mb-1 text-white">
              ...
              <br /> <span className="text-[#75FA88]">Through</span> Blockchain
            </h1>
            <img
          ...
          "
            ...
            <p className="text-xl ml-[225px] w-[496px] mt-2 text-white">
              ...
              Navigate the New Era of Digital Property Transactions with Ease
              and Security.
            </p>
          </div>
